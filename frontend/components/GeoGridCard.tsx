            ...
            {geoGrid.points.map((point) => {
              ...
              return (
                <Popover.Root key={point.label}>
                  ...
                  >
                    {/* Le rang est LISIBLE sans toucher : devoir taper les neuf
                        points annulerait l'intérêt d'une Geo-Grid. Le clic
                        garde son rôle — il révèle le concurrent qui devance. */}
                    <GeoPin position={point.position} status={status} />
                  </Popover.Trigger>
                  <Popover.Portal>
